...
public class WeaknessAntidoteItem extends Item {
    public WeaknessAntidoteItem(Settings settings) {
        super(settings);
    }
...
public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    ...
    tooltip.add(Text.translatable("item.wwantidotes.weakness_antidote.desc"));
