...
public class PoisonAntidoteItem extends Item {
    public PoisonAntidoteItem(Settings settings) {
        super(settings);
    }
...
public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    ...
    tooltip.add(Text.translatable("item.wwantidotes.poison_antidote.desc"));
