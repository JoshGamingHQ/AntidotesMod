...
public class MiningFatigueAntidoteItem extends Item {
    public MiningFatigueAntidoteItem(Settings settings) {
        super(settings);
    }
...
public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    ...
    tooltip.add(Text.translatable("item.wwantidotes.mining_fatigue_antidote.desc"));
