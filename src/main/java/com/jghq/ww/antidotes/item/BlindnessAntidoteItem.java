...
public class BlindnessAntidoteItem extends Item {
    public BlindnessAntidoteItem(Settings settings) {
        super(settings);
    }
...
public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    ...
    tooltip.add(Text.translatable("item.wwantidotes.blindness_antidote.desc"));
