...
public class HungerAntidoteItem extends Item {
    public HungerAntidoteItem(Settings settings) {
        super(settings);
    }
...
public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    ...
    tooltip.add(Text.translatable("item.wwantidotes.hunger_antidote.desc"));
